  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.46\paperwidth}
      ...
      \begin{block}{Evaluation Crisis in Generative Music}
          The current state of evaluation in generative music is \textbf{methodologically fragmented}, relies on \textbf{ambiguous validation objectives}, and builds on \textbf{systematically misaligned metrics} \cite{lerch_survey_2025}. This has led to a crisis in the field, where the following failures are observed:
      ...
      \begin{block}{Software Architecture}
        ...
        \begin{itemize}
          ...
          \item \textbf{Multi-dimensional results \& visualization:}
              ...
              \begin{figure}[!h]
                \centering
                \includegraphics[width=.6\linewidth]{graph/Mockup.pdf}
