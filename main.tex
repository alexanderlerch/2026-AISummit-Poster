...
\begin{frame}[t]
  ...
  \begin{block}{TL;DR}
    \begin{center}
      A community-governed, multi-dimensional evaluation ecosystem for music AI replacing static leaderboards with transparent, reproducible \textit{benchmark profiles}.
    \end{center}
