...
\begin{picture}(91, 46)
  \setlength\fboxsep{0pt}
    ...
    % 2. TC
      ...
      {\tiny\relsize{-6} reproductibility reqs.}}}}}
    ...
    \put(67, 0){\colorbox{white!20}{\framebox(24, 20){\shortstack{\textbf{Community}\\\textbf{Review Process}\\
      ...
      {\tiny\relsize{-6} depreciation policy.}}}}}
    ...
    {\linethickness{1.5pt}
     ...
     \put(24,12){\vector(1,0){8}}     % From gen Data
    
     \put(59, 16){\vector(1,0){8}}     % From feat Data
     \put(67, 8){\vector(-1,0){8}}     % From feat Data
